 ...
 */
final class Version20231206083101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE evenement_user1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement_user1 (evenement_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_2EC0B3C4A76ED395 (user_id), INDEX IDX_1FFB29ADFD02F13 (evenement_id), PRIMARY KEY(evenement_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
