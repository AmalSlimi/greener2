 ...
 */
final class Version20231205231121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement_user1 DROP FOREIGN KEY FK_2EC0B3C4A76ED395');
        $this->addSql('DROP INDEX IDX_2EC0B3C4A76ED395 ON evenement_user1');
        $this->addSql('DROP INDEX `primary` ON evenement_user1');
        $this->addSql('ALTER TABLE evenement_user1 DROP FOREIGN KEY FK_2EC0B3C4FD02F13');
        $this->addSql('ALTER TABLE evenement_user1 CHANGE user_id user1_id INT NOT NULL');
        $this->addSql('ALTER TABLE evenement_user1 ADD CONSTRAINT FK_1FFB29AD56AE248B FOREIGN KEY (user1_id) REFERENCES user1 (id) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_1FFB29AD56AE248B ON evenement_user1 (user1_id)');
        $this->addSql('ALTER TABLE evenement_user1 ADD PRIMARY KEY (evenement_id, user1_id)');
        $this->addSql('DROP INDEX idx_2ec0b3c4fd02f13 ON evenement_user1');
        $this->addSql('CREATE INDEX IDX_1FFB29ADFD02F13 ON evenement_user1 (evenement_id)');
        $this->addSql('ALTER TABLE evenement_user1 ADD CONSTRAINT FK_2EC0B3C4FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id) ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX uniq_8d93d649e7927c74 ON user1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit_vehicule (produit_id INT NOT NULL, vehicule_id INT NOT NULL, INDEX IDX_30CD0E4A4A3511 (vehicule_id), INDEX IDX_30CD0EF347EFB (produit_id), PRIMARY KEY(produit_id, vehicule_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE evenement_user1 DROP FOREIGN KEY FK_1FFB29AD56AE248B');
        $this->addSql('DROP INDEX IDX_1FFB29AD56AE248B ON evenement_user1');
        $this->addSql('DROP INDEX `PRIMARY` ON evenement_user1');
        $this->addSql('ALTER TABLE evenement_user1 DROP FOREIGN KEY FK_1FFB29ADFD02F13');
        $this->addSql('ALTER TABLE evenement_user1 CHANGE user1_id user_id INT NOT NULL');
        $this->addSql('ALTER TABLE evenement_user1 ADD CONSTRAINT FK_2EC0B3C4A76ED395 FOREIGN KEY (user_id) REFERENCES user1 (id) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_2EC0B3C4A76ED395 ON evenement_user1 (user_id)');
        $this->addSql('ALTER TABLE evenement_user1 ADD PRIMARY KEY (evenement_id, user_id)');
        $this->addSql('DROP INDEX idx_1ffb29adfd02f13 ON evenement_user1');
        $this->addSql('CREATE INDEX IDX_2EC0B3C4FD02F13 ON evenement_user1 (evenement_id)');
        $this->addSql('ALTER TABLE evenement_user1 ADD CONSTRAINT FK_1FFB29ADFD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id) ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX uniq_8c518555e7927c74 ON user1');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user1 (email)');
    }
}
