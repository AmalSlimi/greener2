...
// front user
    ...
    {
        return $this->render('Front/user/commentaire/commentairesUserHome.html.twig', [
            'commentaires' => $commentairesRepository->findAll(),
        ]);
    }
...
public function new1(Request $request, $idPost, EntityManagerInterface $entityManager, BadWordsFilter $badWordsFilter): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        if ($containsBadWords) {
            // The comment contains inappropriate content
            return $this->render('Front/user/commentaire/inappropriate_comment.html.twig');
        }
    ...
    return $this->render('Front/user/commentaire/newCmntUser.html.twig', [
        'commentaire' => $commentaire,
        'form' => $form->createView(),
        'statut' => $commentaire->getStatut(),
    ]);
...
public function showCommentsByPost($idPost, CommentairesRepository $commentairesRepository): Response
{
    ...
    return $this->render('Front/user/commentaire/showCmnt_by_post.html.twig', [
        'comments' => $comments,
    ]);
}
    ...
    {
        return $this->render('Front/user/commentaire/showCmntUser.html.twig', [
            'commentaire' => $commentaire,
        ]);
    }
    ...
    public function edit1(Request $request, Commentaires $commentaire, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('Front/user/commentaire/editCmntUser.html.twig', [
            'commentaire' => $commentaire,
            'form' => $form,
        ]);
    }
